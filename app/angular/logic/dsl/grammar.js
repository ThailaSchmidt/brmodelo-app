...
var grammar = {
    ...
    {"name": "constraint_item", "symbols": [(lexer.has("FK") ? {type: "FK"} : FK), "_", (lexer.has("ARROW") ? {type: "ARROW"} : ARROW), "_", "identifier"], "postprocess": ([,, name]) => ({ type: "fk", ref: name })},
    ...
    {"name": "cardinality", "symbols": [(lexer.has("N") ? {type: "N"} : N), "_", (lexer.has("COLON") ? {type: "COLON"} : COLON), "_", (lexer.has("N") ? {type: "N"} : N)], "postprocess": () => "N:N"},
